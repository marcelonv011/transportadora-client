    ...
    <div class="column is-10 is-offset-1">
      <div v-for="item in freteList" :key="item.id">
        <div v-if="item.statusFrete === 'INTERROMPIDO'">
          ...
          <h1>Voce esta querendo mudar para o estado do frete em cancelado</h1>
        </div>
      </div>
      <textarea
        class="textarea is-primary"
        placeholder="deixe uma observacao porque quer mudar para cancelado"
...
@Component
export default class CanceladoInterrompidoFrete extends Vue {
